...
new Vue(
{
  ...
  //Here we can register any value or collections that hold data
  //for the application
  data: {
  ...
  methods:
  {
    ...
    fetchEvents: function()
    {
      ...
      [
        ...
        },
        {
          id:3,
          name:'SXSW',
          description: 'Music, film and interactive festival in Autin, TX.',
          date:'2016-03-11'
        }
      ];
    ...
    deleteEvent: function(index)
    {
        if(confirm("Are you sure you want to delete this event?")){
          //$remove is a Vue conveniencemethod similar to splice
